    ...
    return (
        <div className="flex flex-col h-full bg-[#F8FAFC]">
            ...
            <Tabs defaultValue="users" className="flex-1 flex flex-col">
                <div className="px-8 border-b border-gray-200">
                    <TabsList className="bg-transparent h-12 p-0 space-x-6">
                        <TabsTrigger 
                            value="users" 
                            className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#0F3B2C] data-[state=active]:text-[#0F3B2C] rounded-none px-0 h-12 text-gray-500 font-semibold"
                        >
                            User Management
                        </TabsTrigger>
                        <TabsTrigger 
                ...
                <TabsContent value="users" className="flex-1 p-8 m-0 border-none outline-none">
                    <div className="flex justify-between items-center mb-6">
                        <div className="relative w-96">
                            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                            <Input className="pl-10 rounded-full bg-white border-gray-200 focus-visible:ring-[#0F3B2C] shadow-sm" placeholder="Search by name, NISN/NIP, or role..." />
                        </div>
                        <Button className="bg-[#0F3B2C] hover:bg-[#154E3A] rounded-full px-6 flex items-center gap-2">
                ...
                <TabsContent value="ai-config" className="flex-1 p-8 m-0 border-none outline-none">
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center text-gray-500">
                        AI System Configuration coming soon...
                    </div>
                </TabsContent>
            </Tabs>
            ...
            <div className="p-4 bg-white border-t border-gray-200 flex items-center justify-between">
                <span className="text-sm text-gray-500 font-medium">Last applied: <span className="text-gray-900 font-bold">2 hours ago by admin</span></span>
                <div className="flex gap-3">
                    <Button variant="outline" className="rounded-full px-6">Discard Changes</Button>
                    <Button className="bg-[#0F3B2C] hover:bg-[#154E3A] rounded-full px-6 flex items-center gap-2">
