...
export default function AIConfigTab() {
    ...
    return (
        <div className="flex-1 p-8 m-0 border-none outline-none flex flex-col h-full">
            ...
            {/* Bottom Action Bar */}
            <div className="mt-8 p-4 bg-white border-t border-gray-200 flex items-center justify-between rounded-b-xl shadow-sm -mx-8 -mb-8">
